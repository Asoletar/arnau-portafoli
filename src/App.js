...
// 🔥 **Component de transició avançada amb màscara**
function PageTransition({ children }) {
  return (
    <motion.div
      initial={{ clipPath: "inset(100% 0% 0% 0%)" }} // Comença totalment ocult
      animate={{ clipPath: "inset(0% 0% 0% 0%)" }} // Es revela totalment
      exit={{ clipPath: "inset(0% 0% 100% 0%)" }} // Es tanca cap avall
